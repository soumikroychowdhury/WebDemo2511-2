...
function AddCourse(){
    ...
    return <div>
        <div style={{paddingTop: 140, marginBottom: 6, display: 'flex', justifyContent: 'center'}}><Card variant={'outlined'} style={{width:400,padding:6}}>
        ...
        <Button size={'large'} variant="contained" onClick={async()=>{
            ...
            await axios.post('http://localhost:3000/admin/courses',{
                ...
                headers:{'Authorization':'Bearer '+localStorage.getItem('token')}});alert('Course Addded');
        }}>Add Course</Button>
        </Card></div>
    </div>
}
